CREATE TABLE IF NOT EXISTS dwd.price_history_daily (
...
CREATE INDEX IF NOT EXISTS idx_price_history_daily_bucket_start
ON dwd.price_history_daily (bucket_start DESC);
