...
class DataServiceTests(unittest.TestCase):
    def test_default_date_range_is_clipped_to_available_data(self):
            ...
            [
                {
                    ...
                    "available_start": pd.Timestamp("2025-12-01").date(),
        ...
        self.assertEqual(payload["selected_range"]["start"], "2025-12-01")
        self.assertEqual(payload["selected_range"]["end"], "2026-04-01")
        self.assertEqual(payload["summary"]["price_points"], 2)
        self.assertEqual(payload["summary"]["return_points"], 1)
